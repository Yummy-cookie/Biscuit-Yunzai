...
export default class Runtime {
  ...
  async render (plugin, path, data = {}, cfg = {}) {
    ...
    let yunzaiResPath = `../../../${lodash.repeat('../', paths.length)}plugins/genshin/system/resources/`
    ...
    data = {
      ...
      /** yunzai 相关参数 **/
      copyright: `Created By Yunzai-Bot<span class="version">${Version.yunzai}</span> `,
      _res_path: pluResPath,
      _yunzai_path: yunzaiResPath,
