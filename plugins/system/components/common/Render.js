import { Version, Cfg } from '#yunzai'
...
const Render = {
  async render (path, params, cfg) {
    ...
    return e.runtime.render(cfg.plugin || '../system', path, params, {
      ...
      beforeRender ({ data }) {
        ...
        const layoutPath = process.cwd() + '/plugins/system/resources/common/layout/'
        return {
          _miao_path: resPath,
          ...data,
          _res_path: resPath,
          _layout_path: layoutPath,
          _tpl_path: process.cwd() + '/plugins/system/resources/common/tpl/',
