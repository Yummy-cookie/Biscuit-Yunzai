...
const rPath = `${process.cwd()}/plugins/system/resources`
const CharImg = {
  ...
  getCardImg (names, se = false, def = true) {
    ...
    let addImg = function (charImgPath, disable = false) {
      let dirPath = `./plugins/system/resources/${charImgPath}`
    ...
    for (let name of names) {
      ...
      const plusPath = './plugins/system/resources/miao-res-plus/'
    ...
    let ret = sizeOf(`./plugins/system/resources/${img}`)
    ret.img = img
